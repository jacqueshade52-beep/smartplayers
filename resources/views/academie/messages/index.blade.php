...
<div class="bg-slate-50 min-h-screen pt-32 pb-20">
    <div class="max-w-7xl mx-auto px-6 h-[calc(100vh-160px)] min-h-[600px]">
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('academie.dashboard') }}" class="text-sm text-slate-400 hover:text-benin-green inline-block mb-1"><i class="fas fa-arrow-left mr-1"></i> Dashboard</a>
            <h1 class="text-2xl font-extrabold text-benin-dark flex items-center gap-2">
                <i class="fas fa-comment-dots text-slate-300"></i> Messagerie Académie
            </h1>
        </div>
